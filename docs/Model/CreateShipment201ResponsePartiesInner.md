...
**attributes** | [**\Zippendo\Sdk\Model\CreateShipment201ResponsePartiesInnerAttributesInner[]**](CreateShipment201ResponsePartiesInnerAttributesInner.md) | Additional carrier-specific attributes for the party. |
