...
/**
 * ListCarrierProducts200ResponseInnerServicesInner Class Doc Comment
 *
 * @category Class
 * @package  Zippendo\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class ListCarrierProducts200ResponseInnerServicesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'listCarrierProducts_200_response_inner_services_inner';
     ...
     * Sets name
     *
     * @param string $name Display name of the additional service
     *
     * @return self
     */
     ...
     * Sets service_id
     *
     * @param string $service_id Unique service identifier
     *
     * @return self
     */
