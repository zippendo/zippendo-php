...
/**
 * BatchSplitShipmentRequest Class Doc Comment
 *
 * @category Class
 * @package  Zippendo\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class BatchSplitShipmentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'batchSplitShipment_request';
    ...
    protected static $openAPITypes = [
        'parcel_id' => 'string',
        'shipments' => '\Zippendo\Sdk\Model\BatchSplitShipmentRequestShipmentsInner[]',
        'carrier_id' => 'string',
        'product_id' => 'string',
        'services' => 'string[]',
     ...
     * Sets parcel_id
     *
     * @param string $parcel_id Parcel whose order lines are split across new shipments.
     *
     * @return self
     */
     ...
     * Gets shipments
     *
     * @return \Zippendo\Sdk\Model\BatchSplitShipmentRequestShipmentsInner[]
     */
     ...
     * Sets shipments
     *
     * @param \Zippendo\Sdk\Model\BatchSplitShipmentRequestShipmentsInner[] $shipments New shipments to create from the split parcel.
     *
     * @return self
     */
    public function setShipments($shipments)
    {
        ...
        if ((count($shipments) < 1)) {
            throw new \InvalidArgumentException('invalid length for $shipments when calling BatchSplitShipmentRequest., number of items must be greater than or equal to 1.');
        }
     ...
     * Sets carrier_id
     *
     * @param string|null $carrier_id Carrier for all new shipments. Copied from the original if omitted.
     *
     * @return self
     */
     ...
     * Sets product_id
     *
     * @param string|null $product_id Carrier product for all new shipments. Copied from the original if omitted.
     *
     * @return self
     */
     ...
     * Sets services
     *
     * @param string[]|null $services Service codes for all new shipments. Copied from the original if omitted.
     *
     * @return self
     */
