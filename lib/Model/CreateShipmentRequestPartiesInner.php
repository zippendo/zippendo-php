...
/**
 * CreateShipmentRequestPartiesInner Class Doc Comment
 *
 * @category Class
 * @package  Zippendo\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class CreateShipmentRequestPartiesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'createShipment_request_parties_inner';
    ...
    protected static $openAPITypes = [
        ...
        'email' => 'string',
        'phone' => 'string',
        'attributes' => '\Zippendo\Sdk\Model\CreateShipmentRequestPartiesInnerAttributesInner[]'
    ];
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateShipmentRequestPartiesInner., must be bigger than or equal to 1.');
        }
    ...
    public function setAddress1($address1)
    {
        ...
        if ((mb_strlen($address1) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address1 when calling CreateShipmentRequestPartiesInner., must be bigger than or equal to 1.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        ...
        if ((mb_strlen($postal_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling CreateShipmentRequestPartiesInner., must be bigger than or equal to 1.');
        }
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling CreateShipmentRequestPartiesInner., must be bigger than or equal to 1.');
        }
    ...
    public function setCountryCode($country_code)
    {
        ...
        if ((mb_strlen($country_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling CreateShipmentRequestPartiesInner., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($country_code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling CreateShipmentRequestPartiesInner., must be bigger than or equal to 2.');
        }
    ...
    public function setEmail($email)
    {
        ...
        if (!is_null($email) && (!preg_match("/^(?!\\.)(?!.*\\.\\.)([A-Za-z0-9_'+\\-\\.]*)[A-Za-z0-9_+-]@([A-Za-z0-9][A-Za-z0-9\\-]*\\.)+[A-Za-z]{2,}$/", ObjectSerializer::toString($email)))) {
            throw new \InvalidArgumentException("invalid value for \$email when calling CreateShipmentRequestPartiesInner., must conform to the pattern /^(?!\\.)(?!.*\\.\\.)([A-Za-z0-9_'+\\-\\.]*)[A-Za-z0-9_+-]@([A-Za-z0-9][A-Za-z0-9\\-]*\\.)+[A-Za-z]{2,}$/.");
        }
     ...
     * Gets attributes
     *
     * @return \Zippendo\Sdk\Model\CreateShipmentRequestPartiesInnerAttributesInner[]|null
     */
     ...
     * Sets attributes
     *
     * @param \Zippendo\Sdk\Model\CreateShipmentRequestPartiesInnerAttributesInner[]|null $attributes Additional carrier-specific attributes for the party.
     *
     * @return self
     */
