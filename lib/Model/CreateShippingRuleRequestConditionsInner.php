...
/**
 * CreateShippingRuleRequestConditionsInner Class Doc Comment
 *
 * @category Class
 * @package  Zippendo\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class CreateShippingRuleRequestConditionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'createShippingRule_request_conditions_inner';
    ...
    public function setMin($min)
    {
        ...
        if (($min < 0)) {
            throw new \InvalidArgumentException('invalid value for $min when calling CreateShippingRuleRequestConditionsInner., must be bigger than or equal to 0.');
        }
    ...
    public function setMax($max)
    {
        ...
        if (($max < 0)) {
            throw new \InvalidArgumentException('invalid value for $max when calling CreateShippingRuleRequestConditionsInner., must be bigger than or equal to 0.');
        }
    ...
    public function setShippingPrice($shipping_price)
    {
        ...
        if (($shipping_price < 0)) {
            throw new \InvalidArgumentException('invalid value for $shipping_price when calling CreateShippingRuleRequestConditionsInner., must be bigger than or equal to 0.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CreateShippingRuleRequestConditionsInner., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CreateShippingRuleRequestConditionsInner., must be bigger than or equal to 3.');
        }
    ...
    public function setValue($value)
    {
        ...
        if (($value > 9007199254740991)) {
            throw new \InvalidArgumentException('invalid value for $value when calling CreateShippingRuleRequestConditionsInner., must be smaller than or equal to 9007199254740991.');
        }
        if (($value < 0)) {
            throw new \InvalidArgumentException('invalid value for $value when calling CreateShippingRuleRequestConditionsInner., must be bigger than or equal to 0.');
        }
