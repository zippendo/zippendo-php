...
/**
 * ListShipments200ResponseDataInnerCarrierSettingsAdditionalParametersValueAnyOf Class Doc Comment
 *
 * @category Class
 * @package  Zippendo\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class ListShipments200ResponseDataInnerCarrierSettingsAdditionalParametersValueAnyOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'listShipments_200_response_data_inner_carrierSettings_additionalParameters_value_anyOf';
    ...
    public function setCoordinates($coordinates)
    {
        ...
        if ((count($coordinates) > 2)) {
            throw new \InvalidArgumentException('invalid value for $coordinates when calling ListShipments200ResponseDataInnerCarrierSettingsAdditionalParametersValueAnyOf., number of items must be less than or equal to 2.');
        }
        if ((count($coordinates) < 2)) {
            throw new \InvalidArgumentException('invalid length for $coordinates when calling ListShipments200ResponseDataInnerCarrierSettingsAdditionalParametersValueAnyOf., number of items must be greater than or equal to 2.');
        }
