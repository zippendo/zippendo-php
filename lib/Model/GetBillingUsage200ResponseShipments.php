...
/**
 * GetBillingUsage200ResponseShipments Class Doc Comment
 *
 * @category Class
 * @package  Zippendo\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class GetBillingUsage200ResponseShipments implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getBillingUsage_200_response_shipments';
    ...
    protected static $setters = [
        ...
        'overage' => 'setOverage',
        'overage_charges' => 'setOverageCharges'
    ];
    ...
    protected static $getters = [
        ...
        'overage' => 'getOverage',
        'overage_charges' => 'getOverageCharges'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('overage_charges', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['overage'] === null) {
            $invalidProperties[] = "'overage' can't be null";
        }
        if ($this->container['overage_charges'] === null) {
            $invalidProperties[] = "'overage_charges' can't be null";
        }
     ...
     * Sets used
     *
     * @param float $used Shipments created this period
     *
     * @return self
     */
     ...
     * Sets included
     *
     * @param float $included Shipments included in the plan
     *
     * @return self
     */
     ...
     * Sets overage
     *
     * @param float $overage Shipments above the included allowance
     *
     * @return self
     */
    ...
    /**
     * Gets overage_charges
     *
     * @return float
     */
    public function getOverageCharges()
    {
        return $this->container['overage_charges'];
    }
     ...
     * @return self
     */
    public function setOverageCharges($overage_charges)
    {
        if (is_null($overage_charges)) {
            throw new \InvalidArgumentException('non-nullable overage_charges cannot be null');
        }
        $this->container['overage_charges'] = $overage_charges;
