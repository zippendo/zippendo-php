...
/**
 * CreateShippingRuleRequestAdditionalParametersAnyOfInner Class Doc Comment
 *
 * @category Class
 * @package  Zippendo\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class CreateShippingRuleRequestAdditionalParametersAnyOfInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'createShippingRule_request_additionalParameters_anyOf_inner';
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateShippingRuleRequestAdditionalParametersAnyOfInner., must be bigger than or equal to 1.');
        }
