...
/**
 * CreateOrderRequestOrderLinesInner Class Doc Comment
 *
 * @category Class
 * @package  Zippendo\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class CreateOrderRequestOrderLinesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'createOrder_request_orderLines_inner';
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateOrderRequestOrderLinesInner., must be bigger than or equal to 1.');
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity > 9007199254740991)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling CreateOrderRequestOrderLinesInner., must be smaller than or equal to 9007199254740991.');
        }
        if (($quantity <= 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling CreateOrderRequestOrderLinesInner., must be bigger than 0.');
        }
    ...
    public function setUnitPrice($unit_price)
    {
        ...
        if (!is_null($unit_price) && ($unit_price < 0)) {
            throw new \InvalidArgumentException('invalid value for $unit_price when calling CreateOrderRequestOrderLinesInner., must be bigger than or equal to 0.');
        }
    ...
    public function setTotalPrice($total_price)
    {
        ...
        if (!is_null($total_price) && ($total_price < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_price when calling CreateOrderRequestOrderLinesInner., must be bigger than or equal to 0.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if (!is_null($currency) && (mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CreateOrderRequestOrderLinesInner., must be smaller than or equal to 3.');
        }
        if (!is_null($currency) && (mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CreateOrderRequestOrderLinesInner., must be bigger than or equal to 3.');
        }
    ...
    public function setWeight($weight)
    {
        ...
        if (!is_null($weight) && ($weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling CreateOrderRequestOrderLinesInner., must be bigger than or equal to 0.');
        }
    ...
    public function setCountryOfOrigin($country_of_origin)
    {
        ...
        if (!is_null($country_of_origin) && (mb_strlen($country_of_origin) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country_of_origin when calling CreateOrderRequestOrderLinesInner., must be smaller than or equal to 2.');
        }
        if (!is_null($country_of_origin) && (mb_strlen($country_of_origin) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country_of_origin when calling CreateOrderRequestOrderLinesInner., must be bigger than or equal to 2.');
        }
