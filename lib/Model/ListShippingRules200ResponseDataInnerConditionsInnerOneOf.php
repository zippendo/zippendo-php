...
/**
 * ListShippingRules200ResponseDataInnerConditionsInnerOneOf Class Doc Comment
 *
 * @category Class
 * @package  Zippendo\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class ListShippingRules200ResponseDataInnerConditionsInnerOneOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'listShippingRules_200_response_data_inner_conditions_inner_oneOf';
     ...
     * Sets min
     *
     * @param float $min Minimum weight in kg (inclusive)
     *
     * @return self
     */
    public function setMin($min)
    {
        ...
        if (($min < 0)) {
            throw new \InvalidArgumentException('invalid value for $min when calling ListShippingRules200ResponseDataInnerConditionsInnerOneOf., must be bigger than or equal to 0.');
        }
     ...
     * Sets max
     *
     * @param float $max Maximum weight in kg (inclusive)
     *
     * @return self
     */
    public function setMax($max)
    {
        ...
        if (($max < 0)) {
            throw new \InvalidArgumentException('invalid value for $max when calling ListShippingRules200ResponseDataInnerConditionsInnerOneOf., must be bigger than or equal to 0.');
        }
    ...
    public function setShippingPrice($shipping_price)
    {
        ...
        if (($shipping_price < 0)) {
            throw new \InvalidArgumentException('invalid value for $shipping_price when calling ListShippingRules200ResponseDataInnerConditionsInnerOneOf., must be bigger than or equal to 0.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling ListShippingRules200ResponseDataInnerConditionsInnerOneOf., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling ListShippingRules200ResponseDataInnerConditionsInnerOneOf., must be bigger than or equal to 3.');
        }
