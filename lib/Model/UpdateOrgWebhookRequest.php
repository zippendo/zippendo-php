...
/**
 * UpdateOrgWebhookRequest Class Doc Comment
 *
 * @category Class
 * @package  Zippendo\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class UpdateOrgWebhookRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'updateOrgWebhook_request';
     ...
     * Sets name
     *
     * @param string|null $name Human-readable webhook name
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateOrgWebhookRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateOrgWebhookRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setEvents($events)
    {
        ...
        if ((count($events) < 1)) {
            throw new \InvalidArgumentException('invalid length for $events when calling UpdateOrgWebhookRequest., number of items must be greater than or equal to 1.');
        }
    ...
    public function setBrandId($brand_id)
    {
        ...
        if (!is_null($brand_id) && (mb_strlen($brand_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $brand_id when calling UpdateOrgWebhookRequest., must be bigger than or equal to 1.');
        }
