...
/**
 * ListCarrierProducts200ResponseInnerAdditionalParametersInnerOptionsInner Class Doc Comment
 *
 * @category Class
 * @package  Zippendo\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class ListCarrierProducts200ResponseInnerAdditionalParametersInnerOptionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'listCarrierProducts_200_response_inner_additionalParameters_inner_options_inner';
     ...
     * Sets name
     *
     * @param string $name Display label for the option
     *
     * @return self
     */
     ...
     * Sets key
     *
     * @param string $key Machine key for the option
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string $value Value submitted when the option is selected
     *
     * @return self
     */
