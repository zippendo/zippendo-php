...
/**
 * CreateShipment201ResponseLogsInner Class Doc Comment
 *
 * @category Class
 * @package  Zippendo\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class CreateShipment201ResponseLogsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'createShipment_201_response_logs_inner';
    ...
    public const DIRECTION_CARRIER = 'carrier';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['request'] === null && !$this->isNullableSetToNull('request')) {
            $invalidProperties[] = "'request' is required";
        }
     ...
     * Sets direction
     *
     * @param string $direction Direction of the logged request.
     *
     * @return self
     */
     ...
     * Sets request
     *
     * @param mixed|null $request Captured request payload.
     *
     * @return self
     */
     ...
     * Sets response
     *
     * @param mixed|null $response Captured response payload.
     *
     * @return self
     */
     ...
     * Sets status_code
     *
     * @param float|null $status_code HTTP status code of the response.
     *
     * @return self
     */
     ...
     * Sets created_at
     *
     * @param string $created_at Timestamp when the log entry was created.
     *
     * @return self
     */
