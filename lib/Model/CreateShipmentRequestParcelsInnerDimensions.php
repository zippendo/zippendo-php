...
/**
 * CreateShipmentRequestParcelsInnerDimensions Class Doc Comment
 *
 * @category Class
 * @package  Zippendo\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class CreateShipmentRequestParcelsInnerDimensions implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'createShipment_request_parcels_inner_dimensions';
    ...
    public function setLength($length)
    {
        ...
        if (($length < 0)) {
            throw new \InvalidArgumentException('invalid value for $length when calling CreateShipmentRequestParcelsInnerDimensions., must be bigger than or equal to 0.');
        }
    ...
    public function setWidth($width)
    {
        ...
        if (($width < 0)) {
            throw new \InvalidArgumentException('invalid value for $width when calling CreateShipmentRequestParcelsInnerDimensions., must be bigger than or equal to 0.');
        }
    ...
    public function setHeight($height)
    {
        ...
        if (($height < 0)) {
            throw new \InvalidArgumentException('invalid value for $height when calling CreateShipmentRequestParcelsInnerDimensions., must be bigger than or equal to 0.');
        }
