...
/**
 * GetBillingUsage200ResponseAddOnsInner Class Doc Comment
 *
 * @category Class
 * @package  Zippendo\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class GetBillingUsage200ResponseAddOnsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getBillingUsage_200_response_addOns_inner';
    ...
    public const TYPE_EXTRA_CARRIER = 'extra_carrier';
    public const TYPE_EXTRA_CHANNEL = 'extra_channel';
    public const TYPE_ZIPPY = 'zippy';
    ...
    {
        return [
            self::TYPE_EXTRA_CARRIER,
            self::TYPE_EXTRA_CHANNEL,
            self::TYPE_ZIPPY,
        ];
    }
     ...
     * Sets type
     *
     * @param string $type Type of billing add-on
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param float $quantity Number of add-on units purchased
     *
     * @return self
     */
