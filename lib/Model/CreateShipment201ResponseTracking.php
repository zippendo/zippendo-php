...
/**
 * CreateShipment201ResponseTracking Class Doc Comment
 *
 * @category Class
 * @package  Zippendo\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class CreateShipment201ResponseTracking implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'createShipment_201_response_tracking';
     ...
     * Sets url
     *
     * @param string|null $url Public carrier tracking URL.
     *
     * @return self
     */
     ...
     * Sets number
     *
     * @param string|null $number Carrier tracking number.
     *
     * @return self
     */
     ...
     *
     * @param string|null $label_free_code Label-free drop-off code.
     *
     * @return self
     */
