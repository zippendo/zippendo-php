...
/**
 * GetOrder200ResponseShipmentsInnerParcelsInner Class Doc Comment
 *
 * @category Class
 * @package  Zippendo\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class GetOrder200ResponseShipmentsInnerParcelsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getOrder_200_response_shipments_inner_parcels_inner';
    ...
    protected static $openAPITypes = [
        ...
        'order_lines' => '\Zippendo\Sdk\Model\GetOrder200ResponseShipmentsInnerParcelsInnerOrderLinesInner[]'
    ];
     ...
     * Sets weight
     *
     * @param float $weight Parcel weight in the given unit.
     *
     * @return self
     */
    public function setWeight($weight)
    {
        ...
        if (($weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling GetOrder200ResponseShipmentsInnerParcelsInner., must be bigger than or equal to 0.');
        }
     ...
     * Gets order_lines
     *
     * @return \Zippendo\Sdk\Model\GetOrder200ResponseShipmentsInnerParcelsInnerOrderLinesInner[]
     */
     ...
     * Sets order_lines
     *
     * @param \Zippendo\Sdk\Model\GetOrder200ResponseShipmentsInnerParcelsInnerOrderLinesInner[] $order_lines Contents of this parcel.
     *
     * @return self
     */
