...
class CreateShipmentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'createShipment_request';
    ...
    public function setReference($reference)
    {
        ...
        if ((mb_strlen($reference) < 1)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling CreateShipmentRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setParties($parties)
    {
        ...
        if ((count($parties) < 1)) {
            throw new \InvalidArgumentException('invalid length for $parties when calling CreateShipmentRequest., number of items must be greater than or equal to 1.');
        }
    ...
    public function setParcels($parcels)
    {
        ...
        if ((count($parcels) < 1)) {
            throw new \InvalidArgumentException('invalid length for $parcels when calling CreateShipmentRequest., number of items must be greater than or equal to 1.');
        }
