...
/**
 * GetBillingUsage200ResponseCurrentPeriod Class Doc Comment
 *
 * @category Class
 * @package  Zippendo\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class GetBillingUsage200ResponseCurrentPeriod implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getBillingUsage_200_response_currentPeriod';
     ...
     * Sets start
     *
     * @param string $start Start of the current usage period (ISO 8601)
     *
     * @return self
     */
     ...
     * Sets end
     *
     * @param string $end End of the current usage period (ISO 8601)
     *
     * @return self
     */
