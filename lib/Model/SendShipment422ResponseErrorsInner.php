...
/**
 * SendShipment422ResponseErrorsInner Class Doc Comment
 *
 * @category Class
 * @package  Zippendo\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class SendShipment422ResponseErrorsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'sendShipment_422_response_errors_inner';
     ...
     * Sets message
     *
     * @param string $message Carrier-specific error message.
     *
     * @return self
     */
