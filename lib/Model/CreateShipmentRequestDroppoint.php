...
/**
 * CreateShipmentRequestDroppoint Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateShipmentRequestDroppoint implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'createShipment_request_droppoint';
    ...
    public function setCoordinates($coordinates)
    {
        ...
        if ((count($coordinates) > 2)) {
            throw new \InvalidArgumentException('invalid value for $coordinates when calling CreateShipmentRequestDroppoint., number of items must be less than or equal to 2.');
        }
        if ((count($coordinates) < 2)) {
            throw new \InvalidArgumentException('invalid length for $coordinates when calling CreateShipmentRequestDroppoint., number of items must be greater than or equal to 2.');
        }
