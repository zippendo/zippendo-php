...
/**
 * BatchSplitShipmentRequestShipmentsInnerOrderLinesInner Class Doc Comment
 *
 * @category Class
 * @package  Zippendo\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class BatchSplitShipmentRequestShipmentsInnerOrderLinesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'batchSplitShipment_request_shipments_inner_orderLines_inner';
     ...
     * Sets id
     *
     * @param string $id Order line identifier to move.
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param int $quantity Quantity of the order line to move.
     *
     * @return self
     */
    public function setQuantity($quantity)
    {
        ...
        if (($quantity > 9007199254740991)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling BatchSplitShipmentRequestShipmentsInnerOrderLinesInner., must be smaller than or equal to 9007199254740991.');
        }
        if (($quantity <= 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling BatchSplitShipmentRequestShipmentsInnerOrderLinesInner., must be bigger than 0.');
        }
