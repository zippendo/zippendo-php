...
class CreateAddressRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'createAddress_request';
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateAddressRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setAddress1($address1)
    {
        ...
        if ((mb_strlen($address1) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address1 when calling CreateAddressRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setZipcode($zipcode)
    {
        ...
        if ((mb_strlen($zipcode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $zipcode when calling CreateAddressRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling CreateAddressRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPhone($phone)
    {
        ...
        if ((mb_strlen($phone) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling CreateAddressRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets country_code
     *
     * @param string $country_code Country code (ISO 2 or 3 letter)
     *
     * @return self
     */
    public function setCountryCode($country_code)
    {
        ...
        if ((mb_strlen($country_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling CreateAddressRequest., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($country_code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling CreateAddressRequest., must be bigger than or equal to 2.');
        }
    ...
    public function setEmail($email)
    {
        ...
        if ((!preg_match("/^(?!\\.)(?!.*\\.\\.)([A-Za-z0-9_'+\\-\\.]*)[A-Za-z0-9_+-]@([A-Za-z0-9][A-Za-z0-9\\-]*\\.)+[A-Za-z]{2,}$/", ObjectSerializer::toString($email)))) {
            throw new \InvalidArgumentException("invalid value for \$email when calling CreateAddressRequest., must conform to the pattern /^(?!\\.)(?!.*\\.\\.)([A-Za-z0-9_'+\\-\\.]*)[A-Za-z0-9_+-]@([A-Za-z0-9][A-Za-z0-9\\-]*\\.)+[A-Za-z]{2,}$/.");
        }
     ...
     * Sets customs
     *
     * @param array<string,string>|null $customs Customs identifiers (voec, eori, sprn, ioss, fda, duns)
     *
     * @return self
     */
    ...
    public function setAddressTypes($address_types)
    {
        ...
        if ((count($address_types) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address_types when calling CreateAddressRequest., number of items must be greater than or equal to 1.');
        }
    ...
    public function setBrandId($brand_id)
    {
        ...
        if (!is_null($brand_id) && (mb_strlen($brand_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $brand_id when calling CreateAddressRequest., must be bigger than or equal to 1.');
        }
