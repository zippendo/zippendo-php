...
/**
 * CreateApiToken201Response Class Doc Comment
 *
 * @category Class
 * @package  Zippendo\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class CreateApiToken201Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'createApiToken_201_response';
     ...
     * Sets token
     *
     * @param string $token Full API token (only shown once)
     *
     * @return self
     */
