...
/**
 * UpdateCarrierRequest Class Doc Comment
 *
 * @category Class
 * @package  Zippendo\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class UpdateCarrierRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'updateCarrier_request';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['carrier_slug']) && (mb_strlen($this->container['carrier_slug']) < 1)) {
     ...
     * Sets name
     *
     * @param string|null $name Carrier display name
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateCarrierRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setCarrierSlug($carrier_slug)
    {
        ...
        if ((mb_strlen($carrier_slug) < 1)) {
            throw new \InvalidArgumentException('invalid length for $carrier_slug when calling UpdateCarrierRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets config
     *
     * @return array<string,\Zippendo\Sdk\Model\ListCarriers200ResponseDataInnerConfigValue>|null
     */
     ...
     * Sets config
     *
     * @param array<string,\Zippendo\Sdk\Model\ListCarriers200ResponseDataInnerConfigValue>|null $config Carrier configuration (required and optional fields)
     *
     * @return self
     */
    ...
    public function setBrandId($brand_id)
    {
        ...
        if (!is_null($brand_id) && (mb_strlen($brand_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $brand_id when calling UpdateCarrierRequest., must be bigger than or equal to 1.');
        }
