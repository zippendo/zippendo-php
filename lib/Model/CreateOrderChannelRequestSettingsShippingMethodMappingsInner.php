...
/**
 * CreateOrderChannelRequestSettingsShippingMethodMappingsInner Class Doc Comment
 *
 * @category Class
 * @package  Zippendo\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class CreateOrderChannelRequestSettingsShippingMethodMappingsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'createOrderChannel_request_settings_shippingMethodMappings_inner';
    ...
    public function setMatch($match)
    {
        ...
        if ((mb_strlen($match) < 1)) {
            throw new \InvalidArgumentException('invalid length for $match when calling CreateOrderChannelRequestSettingsShippingMethodMappingsInner., must be bigger than or equal to 1.');
        }
    ...
    public function setShippingRuleId($shipping_rule_id)
    {
        ...
        if ((mb_strlen($shipping_rule_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $shipping_rule_id when calling CreateOrderChannelRequestSettingsShippingMethodMappingsInner., must be bigger than or equal to 1.');
        }
