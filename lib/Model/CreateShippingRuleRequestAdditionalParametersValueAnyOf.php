...
/**
 * CreateShippingRuleRequestAdditionalParametersValueAnyOf Class Doc Comment
 *
 * @category Class
 * @package  Zippendo\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class CreateShippingRuleRequestAdditionalParametersValueAnyOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'createShippingRule_request_additionalParameters_value_anyOf';
    ...
    public function setCoordinates($coordinates)
    {
        ...
        if ((count($coordinates) > 2)) {
            throw new \InvalidArgumentException('invalid value for $coordinates when calling CreateShippingRuleRequestAdditionalParametersValueAnyOf., number of items must be less than or equal to 2.');
        }
        if ((count($coordinates) < 2)) {
            throw new \InvalidArgumentException('invalid length for $coordinates when calling CreateShippingRuleRequestAdditionalParametersValueAnyOf., number of items must be greater than or equal to 2.');
        }
