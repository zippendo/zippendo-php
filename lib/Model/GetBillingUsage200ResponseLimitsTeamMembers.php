...
/**
 * GetBillingUsage200ResponseLimitsTeamMembers Class Doc Comment
 *
 * @category Class
 * @package  Zippendo\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class GetBillingUsage200ResponseLimitsTeamMembers implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getBillingUsage_200_response_limits_teamMembers';
     ...
     * Sets used
     *
     * @param float $used Amount of the resource currently used
     *
     * @return self
     */
     ...
     * Sets limit
     *
     * @param float $limit Maximum allowed (-1 for unlimited)
     *
     * @return self
     */
