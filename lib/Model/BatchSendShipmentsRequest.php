...
/**
 * BatchSendShipmentsRequest Class Doc Comment
 *
 * @category Class
 * @package  Zippendo\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class BatchSendShipmentsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'batchSendShipments_request';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['shipment_ids']) > 100)) {
            $invalidProperties[] = "invalid value for 'shipment_ids', number of items must be less than or equal to 100.";
        }
    ...
    public function setShipmentIds($shipment_ids)
    {
        ...
        if ((count($shipment_ids) > 100)) {
            throw new \InvalidArgumentException('invalid value for $shipment_ids when calling BatchSendShipmentsRequest., number of items must be less than or equal to 100.');
        }
        if ((count($shipment_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $shipment_ids when calling BatchSendShipmentsRequest., number of items must be greater than or equal to 1.');
        }
