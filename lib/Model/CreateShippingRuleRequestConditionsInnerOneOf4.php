...
/**
 * CreateShippingRuleRequestConditionsInnerOneOf4 Class Doc Comment
 *
 * @category Class
 * @package  Zippendo\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class CreateShippingRuleRequestConditionsInnerOneOf4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'createShippingRule_request_conditions_inner_oneOf_4';
    ...
    public function setShippingPrice($shipping_price)
    {
        ...
        if (($shipping_price < 0)) {
            throw new \InvalidArgumentException('invalid value for $shipping_price when calling CreateShippingRuleRequestConditionsInnerOneOf4., must be bigger than or equal to 0.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CreateShippingRuleRequestConditionsInnerOneOf4., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CreateShippingRuleRequestConditionsInnerOneOf4., must be bigger than or equal to 3.');
        }
