...
/**
 * CreateShipmentRequestParcelsInnerOrderLinesInner Class Doc Comment
 *
 * @category Class
 * @package  Zippendo\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class CreateShipmentRequestParcelsInnerOrderLinesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'createShipment_request_parcels_inner_orderLines_inner';
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity > 9007199254740991)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling CreateShipmentRequestParcelsInnerOrderLinesInner., must be smaller than or equal to 9007199254740991.');
        }
        if (($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling CreateShipmentRequestParcelsInnerOrderLinesInner., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreateShipmentRequestParcelsInnerOrderLinesInner., must be bigger than or equal to 1.');
        }
    ...
    public function setUnitPrice($unit_price)
    {
        ...
        if (!is_null($unit_price) && ($unit_price < 0)) {
            throw new \InvalidArgumentException('invalid value for $unit_price when calling CreateShipmentRequestParcelsInnerOrderLinesInner., must be bigger than or equal to 0.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if (!is_null($currency) && (mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CreateShipmentRequestParcelsInnerOrderLinesInner., must be smaller than or equal to 3.');
        }
        if (!is_null($currency) && (mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CreateShipmentRequestParcelsInnerOrderLinesInner., must be bigger than or equal to 3.');
        }
    ...
    public function setVatPercent($vat_percent)
    {
        ...
        if (!is_null($vat_percent) && ($vat_percent < 0)) {
            throw new \InvalidArgumentException('invalid value for $vat_percent when calling CreateShipmentRequestParcelsInnerOrderLinesInner., must be bigger than or equal to 0.');
        }
    ...
    public function setCountryOfOrigin($country_of_origin)
    {
        ...
        if ((mb_strlen($country_of_origin) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country_of_origin when calling CreateShipmentRequestParcelsInnerOrderLinesInner., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($country_of_origin) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country_of_origin when calling CreateShipmentRequestParcelsInnerOrderLinesInner., must be bigger than or equal to 2.');
        }
