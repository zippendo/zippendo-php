...
/**
 * GetOrder200ResponseShipmentsInnerParcelsInnerOrderLinesInner Class Doc Comment
 *
 * @category Class
 * @package  Zippendo\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class GetOrder200ResponseShipmentsInnerParcelsInnerOrderLinesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getOrder_200_response_shipments_inner_parcels_inner_orderLines_inner';
     ...
     * Sets id
     *
     * @param string $id Parcel content line ID.
     *
     * @return self
     */
     ...
     * Sets sku
     *
     * @param string|null $sku SKU of the packed item.
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param int $quantity Quantity packed in this parcel.
     *
     * @return self
     */
    public function setQuantity($quantity)
    {
        ...
        if (($quantity > 9007199254740991)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling GetOrder200ResponseShipmentsInnerParcelsInnerOrderLinesInner., must be smaller than or equal to 9007199254740991.');
        }
        if (($quantity <= 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling GetOrder200ResponseShipmentsInnerParcelsInnerOrderLinesInner., must be bigger than 0.');
        }
