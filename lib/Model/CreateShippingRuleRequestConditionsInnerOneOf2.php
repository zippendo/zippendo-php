...
/**
 * CreateShippingRuleRequestConditionsInnerOneOf2 Class Doc Comment
 *
 * @category Class
 * @package  Zippendo\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class CreateShippingRuleRequestConditionsInnerOneOf2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'createShippingRule_request_conditions_inner_oneOf_2';
    ...
    public function setMin($min)
    {
        ...
        if (($min < 0)) {
            throw new \InvalidArgumentException('invalid value for $min when calling CreateShippingRuleRequestConditionsInnerOneOf2., must be bigger than or equal to 0.');
        }
    ...
    public function setMax($max)
    {
        ...
        if (($max < 0)) {
            throw new \InvalidArgumentException('invalid value for $max when calling CreateShippingRuleRequestConditionsInnerOneOf2., must be bigger than or equal to 0.');
        }
    ...
    public function setShippingPrice($shipping_price)
    {
        ...
        if (($shipping_price < 0)) {
            throw new \InvalidArgumentException('invalid value for $shipping_price when calling CreateShippingRuleRequestConditionsInnerOneOf2., must be bigger than or equal to 0.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CreateShippingRuleRequestConditionsInnerOneOf2., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CreateShippingRuleRequestConditionsInnerOneOf2., must be bigger than or equal to 3.');
        }
