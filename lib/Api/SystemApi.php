...
class SystemApi
{
     ...
     * @return \Zippendo\Sdk\Model\HealthCheck200Response
     */
     ...
     * @throws \Zippendo\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Zippendo\Sdk\Model\HealthCheck200Response, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\Zippendo\Sdk\Model\HealthCheck200Response',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\Zippendo\Sdk\Model\HealthCheck200Response';
        $request = $this->healthCheckRequest($contentType);
